...
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations{
	...
	public List queryForList1(String sql, Object[] args) throws DataAccessException {
	...
	//		System.out.println("sql======:"+psToUse);
			handleWarnings(ps);
			return result;
		}
		catch (SQLException ex) {
	...
	public List queryForListEn(String sql, Object[] args) throws DataAccessException {
		return query(sql, args, getColumnMapRowMapper());
	}
