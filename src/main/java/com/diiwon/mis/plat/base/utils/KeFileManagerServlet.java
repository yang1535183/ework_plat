...
public class KeFileManagerServlet extends HttpServlet{
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
	     	//根目录路径，可以指定绝对路径  
			String rootPath = SystemProperties.getInstance().getProperty("uploadFileSavePath");
			//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/  
			String rootUrl = request.getContextPath()+SystemProperties.getInstance().getProperty("uploadFileMappingDir");
	        //图片扩展名  
