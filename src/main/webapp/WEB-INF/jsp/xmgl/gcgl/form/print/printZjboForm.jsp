...
<div style="margin-left:5px"  id="ljlprintaddinfoaqjdbb">
	<table style="width:760px"">
		<tr>
			<td align="center"><B>合肥市建设工程质量安全监督报表</B></td>
		</tr>
	</table>
	<form method="post" >
		<div style="height: 86%; width: 760px; overflow: auto;" >
			<table  style="border:1px solid black; border-collapse: collapse; bordercolor: black;font-size:13px">
				...
				<tr>
					...
					<td style="border:1px solid black" width="127">&nbsp;${TBAEGCZJ.yszj}万元</td>
			  </tr>
			  <tr>
			 ...
			 <tr>
				...
				<tr>
					...
					<td style="border:1px solid black" colspan="2">&nbsp;${TBAEGCZJ.lsjz}M²
					</td>
					<td style="border:1px solid black" colspan="4">
						<div align="center">
				...
				<tr>
					...
					<td style="border:1px solid black" colspan="3">
						<p>
							<input id="sjc" type="checkbox" name="sjc" value="${TBAEGCZJ.tBaeGczjsx.sjc}"
							<c:if test="${TBAEGCZJ.tBaeGczjsx.sjc=='1'}">checked</c:if> />深基坑
							<input id="gdmb" type="checkbox" name="gdmb" value="${TBAEGCZJ.tBaeGczjsx.gdmb}"
							<c:if test="${TBAEGCZJ.tBaeGczjsx.gdmb=='1'}">checked</c:if>/>高大模板 
							<input id="gkzy" type="checkbox" name="gkzy" value="${TBAEGCZJ.tBaeGczjsx.gkzy}"
							<c:if test="${TBAEGCZJ.tBaeGczjsx.gkzy=='1'}">checked</c:if>/>30M以上高空作业<br />
							<input id="pj" type="checkbox" name="pj" value="${TBAEGCZJ.tBaeGczjsx.pj}"
							<c:if test="${TBAEGCZJ.tBaeGczjsx.pj=='1'}">checked</c:if>/>爬架 
							<input id="rhdt" type="checkbox" name="rhdt" value="${TBAEGCZJ.tBaeGczjsx.rhdt}"
							<c:if test="${TBAEGCZJ.tBaeGczjsx.rhdt=='1'}">checked</c:if>/>人货电梯 
							<input id="td" type="checkbox" name="td" value="${TBAEGCZJ.tBaeGczjsx.td}"
							<c:if test="${TBAEGCZJ.tBaeGczjsx.td=='1'}">checked</c:if>/>塔吊 
							<input id="wxqt" type="checkbox" name="wxqt" value="${TBAEGCZJ.tBaeGczjsx.wxqt}"
					...
					<td style="border:1px solid black" colspan="3">
						<p>
							<input id="ljgyx" type="checkbox" name="ljgyx" value="${TBAEGCZJ.tBaeGczjsx.ljgyx}" 
							<c:if test="${TBAEGCZJ.tBaeGczjsx.ljgyx=='1'}">checked</c:if>/>临近高压线<br />
							<input id="ljjmq" type="checkbox" name="ljjmq" value="${TBAEGCZJ.tBaeGczjsx.ljjmq}"
							<c:if test="${TBAEGCZJ.tBaeGczjsx.ljjmq=='1'}">checked</c:if> />临近居民区,商业区
							<input id="zbqt" type="checkbox" name="zbqt" value="${TBAEGCZJ.tBaeGczjsx.zbqt}" 
							<c:if test="${TBAEGCZJ.tBaeGczjsx.zbqt=='1'}">checked</c:if>/>其他
						</p>
					</td>
				</tr>
				<tr>
						...
						<p align="left" >
							<table style="font-size:13px">
								<tr>
									...
									<td style="width: 210px;">（1万M²以内至少一人）</td>
								</tr>
								<tr>
				...
				<tr>
					...
					<td style="border:1px solid black" colspan="4"><div align="left" style="margin: 0px 20px">
							...
							<div>审查人:<input id="scr" type="text" name="scr" value="${TBAEGCZJ.tBaeGczjdw.scr}"/> </div>
							</p>
							<p><br /></p>
						</div>
				...
				<tr>
					...
					<td style="border:1px solid black" colspan="3">&nbsp;&nbsp;${TBAEGCZJ.tBaeGczjdw.jdzch}</td>
				</tr>
			</table>
			</table>
			<table style="width: 760px; ">
